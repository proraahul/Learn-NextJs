...
const page = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-around gap-y-10 p-24">
      <h1 className="text-red-500 text-2xl">Login Page For Teacher</h1>
      <Link href={'/login'} className='text-yellow-400 underline hover:no-underline'> Go to Login Page</Link>
      <Link href={'/login/loginStudent'} className='text-yellow-400 underline hover:no-underline'>Go to Student Login Page</Link>
